...
// validateproductCommand is gimbal run validate-product and submits the matching Form remote.
func validateproductCommand(defaults map[gimbal.WorkflowRole]string) *cobra.Command {
