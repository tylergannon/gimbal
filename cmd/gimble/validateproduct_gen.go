...
import (
	...
	validateproduct "github.com/tylergannon/gimble/internal/workflows/validateproduct"
	"github.com/tylergannon/gimble/web"
)

// validateproductHosted is the entry ValidateProduct supplies to the persistent instance.
func validateproductHosted() web.WorkflowEntry {
	return func(ctx context.Context, env gimble.Env, raw json.RawMessage) error {
		var params validateproduct.Params
		if err := json.Unmarshal(raw, &params); err != nil {
			return err
		}
		return validateproduct.ValidateProduct(ctx, env, params)
	}
}

// validateproductCommand is gimble run validate-product: a flag for each field of Params, a
