...
func (b Branch) MarshalJSON() ([]byte, error) {
	...
	for __index, __value := range b.Body {
		if __raw0[__index], err = __jsonMarshal__workflow__Operation__303e4995ef6ab4308e90139dcfa78f5441ee2ed494f43ac6fdd92075f122e2f1(__value); err != nil {
...
func (b *Branch) UnmarshalJSON(data []byte) (err error) {
	...
	if len(wrapper.Body) > 0 {
		...
		for __index, __raw := range __raw0 {
			if __decoded0[__index], err = __jsonUnmarshal__workflow__Operation__303e4995ef6ab4308e90139dcfa78f5441ee2ed494f43ac6fdd92075f122e2f1(__raw); err != nil {
...
func __jsonMarshal__workflow__Operation__303e4995ef6ab4308e90139dcfa78f5441ee2ed494f43ac6fdd92075f122e2f1(value Operation) (json.RawMessage, error) {
	if value == nil {
...
func __jsonUnmarshal__workflow__Operation__303e4995ef6ab4308e90139dcfa78f5441ee2ed494f43ac6fdd92075f122e2f1(data []byte) (Operation, error) {
	var (
