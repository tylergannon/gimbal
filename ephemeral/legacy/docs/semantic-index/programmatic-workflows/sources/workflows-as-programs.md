...
- Core proposal and its status as unimplemented direction:
...
- One context includes immediate prompt material plus retrievable indexed
  files, organized around success: `docs/workflows-as-programs.md:97-123`.
...
- Runtime and unified-context behavior are not on main yet:
  `docs/workflows-as-programs.md:189-198`.
...
direction versus implementation.
