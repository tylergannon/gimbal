...
- **The strongest fit is a semantic sensor inside Gimble, not a supervisor agent replacement.** TypeSafe explicitly describes System One as “for building AI-powered software, not agents”: it neither generates code nor chooses its own next action. Code owns control flow and side effects; Jev supplies narrow common-sense judgments over unstructured data. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:238-265`
- **The product positioning directly includes harness and AI verification.** The use-case map proposes checking prompts, reasoning traces, tool calls, and other AI outputs for jailbreaks, citation errors, hallucinations, mistakes, and response-quality failures; it also names model routing, semantic context retrieval, trace classification, and guardrails as harness uses. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/use-case-map.md:11-32`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/use-case-map.md:54-74`
- **Tool-trace verification is a documented decomposition pattern.** The guide replaces one broad “are the tool calls correct?” judgment with separate Nouls for tool relevance, argument/schema match, identity links between calls and results, coordinate propagation, date match, and unit match. This is a close analogue for Gimble's existing event stream and makes errors attributable to a particular contract. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:497-560`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:561-663`
- **A scalable detector should ask many independent checks over one curated trace window.** All questions see the same state, run in parallel, and do not condition each other. Speculative checks can be computed up front and ignored when irrelevant. This makes one Jev call a plausible way to emit a vector of supervision signals at each meaningful Gimble event. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/introduction.md:27-45`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/primitives.md:360-458`
- **Jev can identify the intervention category but cannot write the intervention.** A Choice can pick among predeclared coaching modes, Nouls can detect particular faults, and Scores can prioritize. The actual steering message must come from a fixed template, retrieved example, human, or generative/reasoning model because Jev 1.13 is not trained for text generation. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:139-143`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/system-one.md:19-29`
- **Code should own the intervention policy.** Deterministic rules and side effects belong in code; Jev's probabilities can feed weighted rules or a downstream classical model. High-confidence, low-risk cases may trigger a template automatically; uncertain or high-risk cases should escalate to a person or reasoning model. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:304-323`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:761-800`
- **The trace state must be intentionally constructed.** Relevant goal, plan, recent model messages, tool arguments/results, policy constraints, and known outcomes can be labeled fields in a JSON object, and instructions should point to the relevant paths. Sending an entire long run is likely to reduce accuracy through distractors and context rot. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:322-398`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:94-102`
- **Jev is intentionally literal and weak at multi-hop inference.** Supervision questions must express the exact observable condition, reduce indirection, and place boundary cases in criteria. Complex diagnoses should be decomposed into smaller checks and combined by code. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:29-33`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:88-98`
- **Exact invariants should not be delegated to Jev.** Counting repeated attempts, comparing timestamps, checking budgets, validating JSON/schema mechanically, matching IDs, enforcing authority boundaries, and evaluating deterministic run status belong in code. Jev is documented as unreliable for counting, arithmetic, date ordering, and inferred structural identities. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:35-86`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:116-137`
- **The agent trace is adversarial state whether or not the agent intended an attack.** Jev treats state as data but does not treat it as hostile by default; injected instructions and text arguing for its own classification can shift answers. Agent prompts, web pages, command output, and model prose can therefore steer the checker. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:104-108`
- **A continuous supervision loop needs labeled outcome data.** The docs recommend plotting confidence against accuracy on the application's own data and note that probabilities can become features for a downstream classical model. Gimble should retain the trace slice, Jev version, full distributions, intervention taken, and observed outcome so thresholds and intervention policy can be evaluated rather than assumed. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:767-800`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/models.md:40-48`
- **A second reasoning model remains the escalation mechanism.** The System One concept explicitly frames confidence as a way to decide when to act and when to escalate to a person or reasoning model. A practical Gimble design is Jev on the hot path for cheap triage, with selective expensive review rather than a second agent crawling every trace. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/system-one.md:39-53`

## Important citation bookmarks

- “AI-powered software, not agents” architecture: `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:238-265`
- Composability claims (structured, parallel, fast, calibrated, consistent): `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:274-302`
- Tool-call trace decomposition: `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:497-663`
- Harness, routing, and guardrail use cases: `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/use-case-map.md:11-32`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/use-case-map.md:54-74`
- Context rot and adversarial-state warning: `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:94-108`
- Literalness, numeric, date, and indirection limits: `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:29-98`
- Non-generation boundary: `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:139-152`
...
- **No explanation or supporting-span field is returned.** The primitive response contains typed values and probabilities, not a rationale or source citation. If a human reviewer needs evidence, Gimble must preserve the evaluated trace window and identify candidate evidence separately. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/api.md:221-322`
- **Jev cannot invent a novel remedy.** A Choice winner is constrained to supplied options, and the generation workaround is explicitly discouraged. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/primitives.md:297-310`; `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/model-jaggedness/jev-1.13.md:139-143`
- **Self-consistency is a design claim, not a guarantee in this source set.** The guide points to a separate cookbook for evidence; evaluate repeated-run variance on the intended Gimble rubric. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/concepts/how-to-build-with-system-one.md:274-299`
...
2. Define a Choice whose options are actions Gimble can actually take. Give each option contrastive coverage, exclusions, and examples. Use `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/primitives/advanced.md:353-395` as the rubric pattern.
...
4. Ask the whole applicable atomic rubric in one call and ignore speculative answers that do not apply. Start at `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/primitives.md:360-458`.
...
5. Re-run before moving an alias or changing rubrics, because the docs warn aliases can change answers. `/Users/tyler/.codex/worktrees/14b6/gimble/ephemeral/projects/jev-gimble-research/token-cache/official-docs/pages/models.md:27-40`
