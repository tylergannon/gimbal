...
Start with the coordinator's [RECOMMENDATION.md](RECOMMENDATION.md), [REVIEW-STATUS.md](REVIEW-STATUS.md), [BRIEF.md](BRIEF.md), and [SOURCES.md](SOURCES.md).
...
Destinations describe expected outputs, not completed or accepted research. The frontier planning pass should reconcile all three reports before selecting code to adopt or dispatching implementation.
...
Tyler requested detached execution and no continued polling after successful launch. A launched run is not evidence of report completion or candidate qualification.
