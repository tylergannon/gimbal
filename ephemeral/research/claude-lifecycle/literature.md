...
5. **No Existing Product Fix**: Gimble is not repaired. The adapter still terminates on the first `ResultMessage`. Session-scoped hosting and explicit completion contracts are proposed policies requiring live validation.
...
- **Canonical Specs**: [`headless.md`](https://code.claude.com/docs/en/headless.md) (Local: [`topic-001/sources/claude-code-headless.md`](/private/tmp/gimble-317-literature/corpus/topic-001/sources/claude-code-headless.md)); Go SDK `transport.go:583-636`, `subprocess.go:129-135` (Local clip: [`topic-005/clips/clip-subprocess-close-lifecycle.md`](/private/tmp/gimble-317-literature/corpus/topic-005/clips/clip-subprocess-close-lifecycle.md)).
...
- **Canonical Specs**: [`tools-reference.md`](https://code.claude.com/docs/en/tools-reference.md); [`env-vars.md`](https://code.claude.com/docs/en/env-vars.md) (Local: [`topic-001/sources/env-vars-and-tools-reference.md`](/private/tmp/gimble-317-literature/corpus/topic-001/sources/env-vars-and-tools-reference.md)).
...
- **Canonical Specs**: Go SDK `messages.go:155-238, 847-950, 1340-1385` (Local: [`topic-002/sources/source-1-go-sdk-types-and-transports.md`](/private/tmp/gimble-317-literature/corpus/topic-002/sources/source-1-go-sdk-types-and-transports.md)); TypeScript SDK reference ([`topic-002/sources/source-2-typescript-agent-sdk-reference.md`](/private/tmp/gimble-317-literature/corpus/topic-002/sources/source-2-typescript-agent-sdk-reference.md)).
...
- **Canonical Specs**: Go SDK `protocol.go:825-840, 1445-1460`; `cli-protocol.md:78-120` (Local clip: [`topic-002/clips/clip-2-wire-transport-correlation-gap.md`](/private/tmp/gimble-317-literature/corpus/topic-002/clips/clip-2-wire-transport-correlation-gap.md)).
...
- **Canonical Specs**: Go SDK `options.go:120-135, 1492-1585`; [`hooks.md`](https://code.claude.com/docs/en/agent-sdk/hooks.md) (Local: [`topic-002/sources/source-4-agent-sdk-hooks-specification.md`](/private/tmp/gimble-317-literature/corpus/topic-002/sources/source-4-agent-sdk-hooks-specification.md)).
...
- **Canonical Specs**: [`structured-outputs`](https://code.claude.com/docs/en/agent-sdk/structured-outputs) (Local: [`topic-003/sources/claude-docs-structured-outputs.md`](/private/tmp/gimble-317-literature/corpus/topic-003/sources/claude-docs-structured-outputs.md); clip: [`topic-003/clips/synthetic-tool-mechanism.md`](/private/tmp/gimble-317-literature/corpus/topic-003/clips/synthetic-tool-mechanism.md)).
...
- In probe `schema-late-notification` on CLI 2.1.270 ([`terra-lifecycle.md`](terra-lifecycle.md); [`topic-003/clips/waiting-turn-conformance-trap.md`](/private/tmp/gimble-317-literature/corpus/topic-003/clips/waiting-turn-conformance-trap.md)), Claude ran background `sleep 9` and yielded an intermediate `ResultMessage`:
...
- **Canonical Specs & Probes**: Go SDK `protocol.go:132-155`; [`terra-lifecycle.md`](terra-lifecycle.md) (`/private/tmp/gimble-317-terra/control-schema/raw.jsonl`).
...
| **Host Completion Tool** | Model declaration coupled with host validation; provides handshake, not semantic truth. | [`matrix.md`](/private/tmp/gimble-317-literature/corpus/topic-003/clips/candidate-completion-mechanisms-matrix.md). |
...
- **Canonical Specs**: [`headless.md`](https://code.claude.com/docs/en/headless.md); Go SDK `transport.go`, `subprocess.go` (Local clip: [`topic-004/clips/clip-01-lifetime-boundaries-and-exit-teardown.md`](/private/tmp/gimble-317-literature/corpus/topic-004/clips/clip-01-lifetime-boundaries-and-exit-teardown.md)).
...
- **Canonical Captures**: Probe runs [`sdk-text/raw-2.jsonl`](/private/tmp/gimble-317-investigation/sdk-text/raw-2.jsonl) and [`sdk-structured/raw-2.jsonl`](/private/tmp/gimble-317-investigation/sdk-structured/raw-2.jsonl) (Local clip: [`topic-004/clips/clip-02-resumed-orphan-task-wire-sequence.md`](/private/tmp/gimble-317-literature/corpus/topic-004/clips/clip-02-resumed-orphan-task-wire-sequence.md)).
...
- **Original Incident Evidence**: Native transcript `/Users/tyler/.claude/projects/-private-tmp-scrabbler-drag-drop-eval/deee5fb6-61a3-4c41-b827-d5033fa663ae.jsonl` proves Opus yielded a waiting turn with `stop_reason: "end_turn"` (lines 326–334 in [`topic-005/clips/clip-transcript-waiting-turn-and-orphan.md`](/private/tmp/gimble-317-literature/corpus/topic-005/clips/clip-transcript-waiting-turn-and-orphan.md)) and normalized records confirm Gimble received an empty result on debrief.
...
All 13 issues from `anthropics/claude-code` are **closed historical reports** tied to past versions ([`topic-005/sources/source-01-upstream-issues.md`](/private/tmp/gimble-317-literature/corpus/topic-005/sources/source-01-upstream-issues.md); [`sol-audit.md`](/private/tmp/gimble-317-literature/verification/sol-audit.md)):
...
## 7. Architectural Synthesis & Proposed Policies for Gimble

### 7.1 Why the Current Gimble Adapter Fails
...
These points constitute a proposed hosting policy requiring live prototyping and testing in Gimble, rather than an established provider contract:
...
/private/tmp/gimble-317-investigation/, /private/tmp/gimble-317-sol/, and
/private/tmp/gimble-317-terra/. The pinned SDK source is in the local Go module
