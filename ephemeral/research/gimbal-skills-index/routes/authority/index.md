...
| Does presence of a `df-*` skill imply a Gimbal built-in? | No. Check actual CLI registration/help. [Operations](../../leaves/07-operations.md), [packaging](../../leaves/11-workflow-packaging.md) |
...
| Does generic proof guidance require committing artifacts here? | Gimbal's repository instructions prohibit committing run/proof output. Other consumer projects retain their own artifact policies; do not export Gimbal's repository rule as a universal restriction. [Methodology](../../leaves/05-methodology.md), [promises](../../leaves/08-promises.md) |
...
| Does a local build update what other agents execute? | `bin/gimbal` and the installed executable are distinct. The user requires post-merge install plus affected skill/plugin refresh. [Build and release](../../leaves/06-build-release.md) |
