...
- Audience: Build/release Gimble. Authority: current code. Worker completion
...
- Audience: Build/release Gimble. Authority: current instruction. Coaching is
  advisory; completion is fulfillment of stated requirements, not a coach gate.
  Citation: ephemeral/agent-steering-requirements.md:L14-L16.
- Audience: Use Gimble. Authority: current code. The first look bounds the
...
- Audience: Use Gimble. Authority: current instruction. `gimble steer` to a
...
- Audience: Use Gimble. Authority: current code/test. A steer during a turn can
...
- Audience: Use Gimble. Authority: current code/test. Lifecycle records carry
...
- Audience: Build/release Gimble. Authority: current instruction. Reuse existing
...
- Audience: Build/release Gimble. Authority: current code. The private recent
  ...
  Citation: supervise.go:L91-L99.
- Audience: Build/release Gimble. Authority: current code/test. Message and tool
...
- Audience: Use Gimble. Authority: current code. If retention or look budget
...
- Audience: Build/release Gimble. Authority: current test. Fast readers stay
...
- Audience: Use Gimble. Authority: current instruction. The steering increment’s acceptance test requires a
...
- Audience: Build/release Gimble. Authority: current instruction. Repeatable
...
- Audience: Build/release Gimble. Authority: historical validation. Calibration
  ...
  Citation: ephemeral/worklog/202609111647-supervisor-bounds.md:L4-L4.
- Audience: Use Gimble. Authority: current instruction. Local control is scoped
