...
- `/Users/tyler/.codex/worktrees/365e/gimble/docs/definition-of-done.md` is the
  current repository gate: requirements plus observed working behavior decide
  completion; style and taste do not block it.
- `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/research/api/SPRINTS.md`
  is the delivery design/history: Godoc is the API contract, the sprint order
  is historical delivery context, and later sprints are themselves Gimble runs.
...
- Authority: current instruction and gate. Work is done when requested behavior
  ...
  hold it up. `/Users/tyler/.codex/worktrees/365e/gimble/docs/definition-of-done.md:7-13`
...
- Authority: current repository design for inline tactics and simple workflows:
  `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/research/api/SPRINTS.md:20-23`;
...
- Conflict: generic loop guidance can suggest more machinery; Gimble's no-wrapper
...
- Authority: historical review evidence: round 01 rejected a proof where the
  ...
  `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/reviews/202609112230-issue125-loop-round-01.md:59-97`;
  round 02 accepted a real failed probe, repair, and deferred nonblocking defect
  `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/reviews/202609112242-issue125-loop-round-02.md:52-86`.
...
- Authority: current design says Godoc is authoritative, API.md records reasons,
  and later delivery is done by `cmd/sprint`; `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/research/api/SPRINTS.md:1-23`.
- Authority: current gate requires an agent to assess whether automation really
  ...
  `/Users/tyler/.codex/worktrees/365e/gimble/docs/definition-of-done.md:15-30`.
- Conflict: generic release/process advice may demand extra artifacts or GitHub
  ...
  GitHub `/Users/tyler/.codex/worktrees/365e/gimble/docs/definition-of-done.md:32-39`.
...
- Authority: current gate and supervisor contract
  `/Users/tyler/.codex/worktrees/365e/gimble/docs/definition-of-done.md:32-53`.
- Historical evidence: round 02 retained only genuine nitpicks after material
  ...
  issue #125 `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/reviews/202609112242-issue125-loop-round-02.md:88-117`.
...
### 6. Use Gimble: distinguish checks, proof, and live operation

- Audience: users of Gimble and validators. Decision: tests, vet, compilation,
...
- Authority: external proof reference states checks are not proof unless they
  ...
  `/Users/tyler/.codex/worktrees/365e/gimble/docs/definition-of-done.md:15-27`.
- Historical evidence: the review rejected scaffolded adaptive proof and later
  ...
  `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/reviews/202609112230-issue125-loop-round-01.md:91-97`
  `/Users/tyler/.codex/worktrees/365e/gimble/ephemeral/reviews/202609112242-issue125-loop-round-02.md:63-81`.
- Retrieval hints: `live run`, `runtime evidence`, `required check`, `proof
  claim`, `independent validation`, `scaffolded proof`.

### 7. Use Gimble: review independently, then converge without bureaucracy
...
### 8. Use Gimble: report evidence and blockers with honest scope
...
- Conflict: generic proof-upload guidance is subordinate to Gimble's current
