...
Audience: Gimble contributors, sprint planners, reviewers, and agents deciding
...
- No source here defines a Gimble builtin command registry. Treat all `python3
  .../ledger.py`, `/df-semantic-index`, and skill phase commands as workflow
  tooling instructions, not as evidence that Gimble exposes those commands.
