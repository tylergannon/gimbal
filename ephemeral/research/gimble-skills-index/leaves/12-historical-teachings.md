...
historical inspiration and rationale, not the current Gimble API. Current
...
Audience: a programmer writing or revising a Gimble workflow.
...
`ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/DIRECTION-CORRECTIONS-VERBATIM.md:L5-L7`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/DIRECTION-CLARIFICATION-VERBATIM.md:L25-L37`;
...
current authoring.
`ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/INPUT-SEPARATION-VERBATIM.md:L1-L2`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/POC-RECOVERY.md:L21-L42`.
...
guarantee.
`ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/CONCURRENCY-SHAPES.md:L10-L21`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/CONCURRENCY-SHAPES.md:L23-L74`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/CONCURRENCY-SHAPES.md:L76-L115`.
...
## Proposed subskill: Build and release Gimble
...
`ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/CONTEXT-REFRAMING-VERBATIM.md:L39-L63`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/DIRECTION-CORRECTIONS-VERBATIM.md:L9-L15`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/ACTIONS-AND-KNOWLEDGE-VERBATIM.md:L23-L25`.
...
`ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/KEY-CLAIM-VERBATIM.md:L8-L16`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/KEY-CLAIM-VERBATIM.md:L14-L16`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/DIRECTION-CORRECTIONS-VERBATIM.md:L13-L15`.
...
not current Gimble commands. Current graph work also removed `graph.json` and
...
`ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/POC-RECOVERY.md:L30-L42`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/POC-RECOVERY.md:L93-L98`; `ephemeral/worklog/202609152233-issue-227-graph.md:L41-L50`.

## Proposed subskill: Use Gimble
...
`ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/POC-WORKFLOWS.md:L19-L25`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/POC-WORKFLOWS.md:L28-L46`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/POC-WORKFLOWS.md:L49-L97`.
...
rationale.
`ephemeral/worklog/interview-249-workflow.md:L3-L10`; `ephemeral/legacy/ephemeral/projects/gimble/programmatic-workflows/CONTEXT-REFRAMING-VERBATIM.md:L59-L63`.
