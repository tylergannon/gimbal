...
- **Files**:
  - `skills/gimbal-release/SKILL.md`
  - `go.mod`
...
From `skills/gimbal-release/SKILL.md` (lines 39–56, 107–125):
...
After every feature or fix merges, reinstall both the CLI and the Gimbal skills
on this machine:
