...
friction: go doc initially could not access the default Go build cache under sandbox; GOCACHE=/private/tmp/gimbal-sprint001-go-cache allowed the required API read without repository mutation.
