...
- decision: Tyler rejected the filed plan's "replay the whole log on open".
  The six files are the data model and Gimbal reads them; the session logs
  ...
  write-only for Gimbal. The three planning lanes conflated reading the
