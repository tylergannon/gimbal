...
friction: just vet is currently blocked after go vet and build by five existing gimble lint findings outside issue 192 -> repair the baseline lint findings separately
