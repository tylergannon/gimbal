# Implement a project issue through Gimble

You are evaluating Gimble for use by your engineering team. The `gimble` binary is
...
Use Gimble to do the implementation and review work, all the way to opening a PR
