...
func Source(dir, entry, name, output, mermaidOutput string) error {
	...
	text, err := format.Source([]byte(graphSource(pkg, entry, graph)))
	if err != nil {
		return fmt.Errorf("generate: %w", err)
	}
...
func graphSource(pkg, entry string, graph workflow.Graph) string {
...
func writeMermaid(dir, name, output string, graph workflow.Graph) error {
	...
	componentSource := fmt.Sprintf(`<!-- Code generated by gimbalgen. DO NOT EDIT. -->
<script lang="ts">
