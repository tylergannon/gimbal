...
func Source(dir, entry, name, output string) error {
	...
	graph, err := extract(dir, entry, name, map[string][]byte{file: []byte("package " + pkg + "\n")})
	if err != nil {
		return err
	}
	text, err := format.Source([]byte(literal(pkg, entry, graph)))
	if err != nil {
		return fmt.Errorf("graph: %w", err)
	}
...
func literal(pkg, entry string, graph workflow.Graph) string {
	var b strings.Builder
	fmt.Fprintf(&b, "// Code generated by gimble graph. DO NOT EDIT.\n\npackage %s\n\n", pkg)
	b.WriteString("import (\n\"github.com/tylergannon/gimble\"\n\"github.com/tylergannon/gimble/workflow\"\n)\n\n")
	b.WriteString("func init() { gimble.RegisterGraph(Graph) }\n\n")
