...
var Graph = workflow.Graph{
	Name:   "execute",
	Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 34},
	Body: []workflow.Operation{
		workflow.Set{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 39}, Key: "sprint document"},
		workflow.Set{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 40}, Key: "blockers file"},
		workflow.Session{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 42}, Name: "worker", From: ""},
		workflow.AgentCall{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 43}, Session: "worker", Role: "worker", Prompt: "You are executing a sprint plan. Read the sprint document named below and work through every task in its Implementation Plan, phase by phase, in order: implement the change, verify it works with the tests and checks the repository has, and move on to the next task. Follow the project's conventions in AGENTS.md, CLAUDE.md, or equivalent. Do not skip tasks, and do not reorder phases unless a dependency requires it. If you hit a blocker you cannot resolve, write what is blocked and why to the blockers file named below and continue with the next unblocked task. If the sprint is linked to a chapter, read the chapter document too and keep the work aligned with its vector and non-goals, preserving the link in the sprint document. If the sprint document has a Pyramid Index, keep it accurate. Answer with what you completed and what you did not."},
		workflow.Command{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 48}, Name: "tests"},
		workflow.Set{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 56}, Key: "tests"},
		workflow.AgentCall{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 57}, Session: "worker", Role: "worker", Prompt: "The repository's tests ran as recorded below. Read the blockers file named below if it exists. Report the tasks completed, the blockers, and the test results."},
		workflow.Condition{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 62}, Branches: []workflow.Branch{
			{Source: workflow.Source{File: "internal/workflows/execute/execute.go", Line: 62}, Case: "code != 0", Exits: true, Body: []workflow.Operation{}},
		}},
	},
}
