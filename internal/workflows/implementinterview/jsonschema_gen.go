...
var (
	__gen_jsonschema_compiled_Assessment *jsonschema.Schema
)
...
func init() {
	...
	{
		var __zero Assessment
		__gen_jsonschema_compiled_Assessment = compile("Assessment", __zero.Schema())
	}
}

func (Assessment) Schema() json.RawMessage {
	const fileName = "jsonschema/Assessment.json"
...
// ValidateJSON validates the given JSON bytes against the schema for Assessment.
func (Assessment) ValidateJSON(data []byte) error {
	inst, err := jsonschema.UnmarshalJSON(bytes.NewReader(data))
	if err != nil {
		return err
	}
	return __gen_jsonschema_compiled_Assessment.Validate(inst)
}
