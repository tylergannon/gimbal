...
func Command() *cobra.Command {
	...
	cmd.Flags().StringVar(&claudeModel, "claude", roles["claude"], "the model for role claude, as model or model:effort")
	cmd.Flags().StringVar(&codexModel, "codex", roles["codex"], "the model for role codex, as model or model:effort")
	cmd.Flags().StringVar(&geminiModel, "gemini", roles["gemini"], "the model for role gemini, as model or model:effort")
