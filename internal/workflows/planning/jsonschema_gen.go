...
var (
	__gen_jsonschema_compiled_synthesis *jsonschema.Schema
)
...
func init() {
	...
	{
		var __zero synthesis
		__gen_jsonschema_compiled_synthesis = compile("synthesis", __zero.Schema())
	}
}

func (synthesis) Schema() json.RawMessage {
	const fileName = "jsonschema/synthesis.json"
...
// ValidateJSON validates the given JSON bytes against the schema for synthesis.
func (synthesis) ValidateJSON(data []byte) error {
	inst, err := jsonschema.UnmarshalJSON(bytes.NewReader(data))
	if err != nil {
		return err
	}
	return __gen_jsonschema_compiled_synthesis.Validate(inst)
}
