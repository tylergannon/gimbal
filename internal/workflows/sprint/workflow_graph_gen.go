		...
		workflow.Repeat{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 90}, Cond: "round := 1; ; round++", Body: []workflow.Operation{
			workflow.Scope{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 91}, Name: "round", Body: []workflow.Operation{
				...
				workflow.Loop{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 95}, Name: "sprint", Planner: "planner", Body: []workflow.Operation{
					...
					workflow.Session{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 208}, Name: "coder", From: "researcher"},
					workflow.Session{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 212}, Name: "supervisor", From: ""},
					workflow.AgentCall{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 213}, Session: "coder", Role: "researcher", Prompt: "Complete the task in the scoped context, following AGENTS.md and ephemeral/research/api/API.md. Demonstrate the result and leave the work uncommitted. Answer with a short summary of what changed and the evidence you gathered.", Supervisors: []workflow.Supervisor{
						{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 214}, Session: "supervisor", Role: "supervisor", Instruction: "Don't let it build what its task does not ask for, over-engineer what it does build, or break a rule in AGENTS.md. Object to nothing else: code quality and style are not yours to judge."},
					}},
					workflow.Set{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 219}, Key: "worker result"},
					workflow.Condition{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 221}, Branches: []workflow.Branch{
						{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 221}, Case: "workErr != nil", Exits: false, Body: []workflow.Operation{
							workflow.Set{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 222}, Key: "worker error"},
						}},
					}},
					workflow.Condition{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 226}, Branches: []workflow.Branch{
						{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 226}, Case: "strings.TrimSpace(task.Validation.Command) != \"\"", Exits: false, Body: []workflow.Operation{
							workflow.Command{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 293}, Name: "check"},
							workflow.Set{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 231}, Key: "task command"},
						}},
					}},
					workflow.AgentCall{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 236}, Session: "validator", Role: "validator", Prompt: "Assess the task using the recorded result and evidence, against the definition of done and, if present, the validation query in the task record of the scoped context below.\n\nList what that evidence does not show working at the repository's 90-95% readiness standard, and nothing else; an empty list passes the task. A passing agent judgment cannot override a failed deterministic check. The work is uncommitted by design: the workflow commits it once you pass it, so its being uncommitted is never a finding. Nor is how the work is written: legitimacy of the evidence is yours to judge, code quality and style are not."},
					workflow.Set{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 240}, Key: "task assessment"},
					workflow.Condition{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 244}, Branches: []workflow.Branch{
						{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 244}, Case: "repositoryChecks.vet != \"\"", Exits: false, Body: []workflow.Operation{
							workflow.Command{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 293}, Name: "check"},
							workflow.Set{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 249}, Key: "repository vet check"},
						}},
					}},
					workflow.Condition{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 254}, Branches: []workflow.Branch{
						{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 254}, Case: "repositoryChecks.test != \"\"", Exits: false, Body: []workflow.Operation{
							workflow.Command{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 293}, Name: "check"},
							workflow.Set{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 259}, Key: "repository test check"},
						}},
					}},
					workflow.Condition{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 264}, Branches: []workflow.Branch{
						{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 264}, Case: "!passed", Exits: true, Body: []workflow.Operation{}},
					}},
					workflow.Command{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 341}, Name: "git"},
					workflow.Command{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 341}, Name: "git"},
					workflow.Condition{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 272}, Branches: []workflow.Branch{
						{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 272}, Case: "status, _ := git(ctx, in, \"status\", \"--porcelain\"); status == \"\"", Exits: true, Body: []workflow.Operation{}},
					}},
					workflow.Command{Source: workflow.Source{File: "internal/workflows/sprint/sprints.go", Line: 341}, Name: "git"},
				}},
			}},
