...
var (
	__gen_jsonschema_compiled_VisualVerdict *jsonschema.Schema
)
...
func init() {
	...
	{
		var __zero VisualVerdict
		__gen_jsonschema_compiled_VisualVerdict = compile("VisualVerdict", __zero.Schema())
	}
}

func (VisualVerdict) Schema() json.RawMessage {
	const fileName = "jsonschema/VisualVerdict.json"
...
// ValidateJSON validates the given JSON bytes against the schema for VisualVerdict.
func (VisualVerdict) ValidateJSON(data []byte) error {
	inst, err := jsonschema.UnmarshalJSON(bytes.NewReader(data))
	if err != nil {
		return err
	}
	return __gen_jsonschema_compiled_VisualVerdict.Validate(inst)
}
