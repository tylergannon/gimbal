...
| Validator | The agent, person, or check assessing acceptance. Gimbal's development method uses an agent to judge whether validation actually demonstrates the requested behavior. |
...
Gimbal's planner-driven loop chooses tasks from a goal, backlog, and prior
