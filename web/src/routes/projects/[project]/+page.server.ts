...
import type { InterviewRow } from "../../../lib/skgo/observation/types";
  ...
  if (building)
    throw new Error(
      "skgo: route " +
        ...
        "src/routes/projects/[project]/page.server.go" +
...
export const load = (event: {
  url: URL;
}): { items: Array<RunItem>; attention: Array<InterviewRow>; now: number } =>
